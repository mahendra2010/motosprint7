                ...
                <div class="row">
                    <div class="col-md-12">
                        <ul class="automobile-breadcrumb">
                            ...
                            <li class="automobile-color"> Blogs</li>
                        </ul>
                    </div>
                </div>
            </div>
						...
						<div class="col-md-9">
                            <div class="automobile-blog automobile-medium-blog">
                                <ul class="row">
                                        ...
                                        <li class="col-md-12">
                                            ...
                                            <div class="automobile-medium-blog-text">
                                               ...
                                               <ul class="automobile-blog-post-comment">
                                                ...
                                                <p><?php echo substr(strip_tags($blog->blog_content), 0, 100); ?>..</p>
                                    ...
                                    <!--<li class="col-md-12">
                                        <figure><a href="#"><img src="http://webmarce.com/html/accelerator/extra-images/related-blog-img2.jpg" alt=""></a></figure>
                                        <div class="automobile-medium-blog-text">
                                            <div class="automobile-social-tag">
                                                <i class="automobile-color fa fa-folder-open"></i>
                                                <a href="#">Mechanics,</a>
                                            ...
                                            <h4><a href="#">How to Test a Car Stereo’s Amplifier</a></h4>
                                            <p>If your stereo system is giving you the silent for it treatment, you don’t have to participate.</p>
                                            <a href="#" class="automobile-read-btn">read article</a>
                                        </div>
                                    </li>-->
